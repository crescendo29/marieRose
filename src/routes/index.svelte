...
<section id="hero" class="flex justify-center">
  <img src="/images/hero.jpg" class="relative bg-cover" alt="massage">
  <div class="absolute bg-marieBlue border-x-4 border-goldish text-white flex flex-col p-6 rounded-full items-center mt-20 shadow-xl">
    <h1>DOUCE &Eacute;VASION</h1>
  <h2>Votre espace bien être à Quimperlé</h2>
  </div>
</section>

<section id="about" class="bg-marieBlue">
...
<a href="#" class="bg-[url('images/gold.jpg')] border-x-4 border-goldish text-marieBlue text-xl font-bold tracking-widest flex flex-col p-6 rounded-full items-center mx-20 shadow-xl">Prendre Rendez-Vous</a>
</section>