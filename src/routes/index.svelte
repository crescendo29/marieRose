...
<section id="hero" class="flex justify-center lg:max-h-screen">
  ...
  <div class="absolute mt-36">
    <a href="https://www.planity.com/" class="bg-gold-texture border-x-4 border-goldish text-marieBlue flex flex-col items-center text-xl font-bold tracking-widest p-6 rounded-full mx-20 shadow-xl hover:scale-105">Prendre Rendez-Vous</a>
