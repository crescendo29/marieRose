<!-- <div class="bg-gold-texture h-[80px] w-full relative z-50 flex items-center justify-center">
  <div class="flex items-center justify-between md:w-1/3 w-3/4 mx-auto text-marieBlue p-2">
...
<p>Developed by <a href="https://www.rodolphebeauverger@vercel.app">Rodolphe Beauverger</a></p>